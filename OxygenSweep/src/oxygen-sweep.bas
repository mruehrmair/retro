...
1410 data"{CBM-+}{rvon} {rvof}.{rvon} {rvof}..{rvon} {rvof}..{rvon} {rvof}.ZZ.{rvon} {rvof}ZZZZ.........{rvon} {rvof}{CBM-+}"
1420 data"{CBM-+}{rvon} {rvof}.{rvon} {rvof}..{rvon} {rvof}.Z{rvon} {rvof}....{rvon} {rvof}ZZZ..........{rvon} {rvof}{CBM-+}"
1430 data"{CBM-+}{rvon} {rvof}.{rvon} {rvof}ZZ{rvon} {rvof}.Z{rvon} {rvof}....{rvon} {rvof}ZZ...........{rvon} {rvof}{CBM-+}"
1440 data"{CBM-+}{rvon} {rvof}.{rvon} {rvof}ZZ{rvon} {rvof}.Z{rvon} {rvof}....{rvon} {rvof}.............{rvon} {rvof}{CBM-+}"
